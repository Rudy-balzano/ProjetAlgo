...
func main(){
    ...
    while !game.endGame() {
        ...
        else if game.redTemple.isOpponentKingOnTemple() && game.currentPlayer.color == "blue" {
            game.currentPlayer.isWinner = true
        }
        else if game.blueTemple.isOpponentKingOnTemple() && game.currentPlayer.color == "red" {
            game.currentPlayer.isWinner = true
        }
